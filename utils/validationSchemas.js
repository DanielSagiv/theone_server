...
const eventSeatSchema = Joi.object({
  ...
  price_change_reason: Joi.string().allow('').optional(),
...
const createEventSchema = Joi.object({
  ...
  livEventCode: Joi.string().allow('').optional(),
  omniaEventCode: Joi.string().allow('').optional(),
  hakkasanEventCode: Joi.string().allow('').optional(),
  taoBeachEventCode: Joi.string().allow('').optional(),
...
const addEventToCOEWithSeatSchema = Joi.object({
  ...
  /** Optional guests for this event line (falls back to COE-level party size when omitted). */
  party_size: Joi.number().integer().min(1).optional(),
  notes: Joi.string().allow(''),
  client_notes: Joi.string().allow(''),
